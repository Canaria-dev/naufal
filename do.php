    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            searchButton.addEventListener('click', function () {
                ...
                window.location.href = 'do.php?keyword=' + keyword;
            });
        });
        ...
        function deleteSelected() {
            ...
            if (selectedData.length > 0) {
                ...
                window.location.href = 'hapus_multiple_do.php?selectedData=' + selectedData.join(',');
            } else {
...
<body>
    ...
    <div id="penduduk">
        <div class="container">
            <h3 class="w3l-title"> Data Mahasiswa Drop Out </h3>
            ...
            <a href="tambah_do.php"> <button class="btn"> Tambah data mahasiswa DO </button> </a>
            <a href="pdf2.php"> <button class="btn">Download PDF </button> </a>
            <div>
                <div>
                    ...
                    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                        ...
                        $query = "SELECT * FROM naufal3";
                        $url_cetak = "print.php";
                        $label = "Semua Data Transaksi";
                    } else { // Jika terisi
                        // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                        $query = "SELECT * FROM naufal3 WHERE (tgl BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
                ...
                <div>
                    <a href="excel2.php"> <button class="btn">input excel </button> </a>
                    <a href="export_excel2.php"> <button class="btn">export excel </button> </a>
                </div>
                <div>
                ...
                <table class="table table-bordered text-center">
                    ...
                    while ($data = mysqli_fetch_array($hasil)) {
                        ...
                        echo "<tr>
                            ...
                            <td width='100'><a href='do_edit.php?kode=$data[nim]'> Edit </a></td>
                            <td width='100'><a href='hapus_do.php?kode=$data[nim]'> Hapus </a></td>
                        </tr>";
                    }
                    ?>
                </table>
            ...
            <ul class="pagination">
                ...
                if ($page == 1) {
                    ...
                    ?>
                    <li><a href="do.php?page=1">First</a></li>
                    <li><a href="do.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                    <?php
                }
                ?>
                <?php
                ...
                $sql2 = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM naufal3");
                ...
                for ($i = $start_number; $i <= $end_number; $i++) {
                    ...
                    ?>
                    <li<?php echo $link_active; ?>><a href="do.php?page=<?php echo $i; ?>">
                            <?php echo $i; ?>
                        </a></li>
                        <?php
                }
                ?>
                    ...
                    if ($page == $jumlah_page) {
                        ...
                        ?>
                        <li><a href="do.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                        <li><a href="do.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                        <?php
                    }
                    ?>
