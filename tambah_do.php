...
<body>
	...
	<div id="Edit_Akun">
		<div class="container">
			<h3 class="w3l-title cl"> Data Mahasiswa Drop Out </h3>
			<div class="container margin-atas">

				<?php
				include('koneksi.php');
				$tampil = "SELECT * FROM `naufal3` ORDER BY `nim` ASC ";
				$hasil = mysqli_query($koneksi, $tampil);
				?>

				<form class="form-group" action="proses_tambah_do.php" method="post" enctype="multipart/form-data">
					<table class="table">
						<tr>
							<td> NIM : </td>
