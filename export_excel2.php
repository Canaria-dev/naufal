...
try {
    ...
    $sheet->setCellValue('A1', "DATA Mahasiswa Dropout")->mergeCells('A1:G1')->getStyle('A1')->getFont()->setBold(true);
    

    // ...

    $headers = ["NIM", "Nama", "Jenis Kelamin", "Asal Kota", "Fakultas", "Prodi","Keterangan"]; // Remove "Foto" from the headers
    ...
    $columns = ['A' => 15, 'B' => 18, 'C' => 25, 'D' => 20, 'E' => 20, 'F' => 20, 'G' => 20];
