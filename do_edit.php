...
<body>
	...
	<div id="Edit_Akun">
		<div class="container">
			<h3 class="w3l-title cl"> Data Mahasiswa DropOut Mahasiswa </h3>
			<div class="container margin-atas">

				<?php
				$Kode = $_GET['kode'];
				$query = mysqli_query($koneksi, "select * from naufal3 where nim='$Kode'");
				$data = mysqli_fetch_array($query);

				$tampil_akun = "SELECT * FROM `naufal3` ORDER BY `nim` ASC ";
				$hasil_akun = mysqli_query($koneksi, $tampil_akun);
				?>

				<form class="form-group" action="proses_edit_do.php" method="post"enctype="multipart/form-data" >
					<table class="table">
						...
						<tr>
							<td> Keterangan DropOut: </td>
							<td> <input type="text" name="keterangan" <?php echo "value='$data[keterangan]'"; ?>> </td>
						</tr>
